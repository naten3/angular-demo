...
export const restoreAppState = key => ({
  type: RESTORE_APP_STATE,
  payload: key
});
export const saveAppStateSuccess = val => ({
  type: SAVE_APP_STATE_SUCCESS,
  payload: val
});
export const saveAppStateFail = e => ({
  type: SAVE_APP_STATE_FAIL,
  payload: e
});
export const restoreAppStateSuccess = s => ({
  type: RESTORE_APP_STATE_SUCCESS,
  payload: s
});
